...
def create_demo(model: Model):
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column():
                gallery_pose_sequence = gr.Gallery(label="Motions", value=[('__assets__/poses_skeleton_gifs/dance1.gif', "Motion 1"), ('__assets__/poses_skeleton_gifs/dance2.gif', "Motion 2"), (
                ...
                input_video_path = gr.Textbox(
                    label="Motion", visible=False, value="Motion 1")
